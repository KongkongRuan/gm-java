...
//        int i1 = msg1.length * x;
//        String s = null;
//
//        //DC580AB9D63FF07847D7CB15EFA04F99902448A26116270629CA2A7671D1E492
//
//        for (int i = 0 ; i < x ; i++) {
...
//        }
//        System.out.println("size: "  + i1 +"byte");
//
//
//        long res = System.currentTimeMillis() - l;
////        System.out.println((i1 / (res/1000)) + "Mbps");
//
//        String ss1 = "abcd";
//        byte[] bytes = ss1.getBytes();
//
//        int i2 = bigEndianByteToInt(bytes);
//        int i = bitCycleLeft(i2, 2);
//        byte[] bytes1 = bigEndianIntToByte(i);
//        System.out.println(Hex.toHexString(bytes1));
        long l = System.currentTimeMillis();
        byte[] sm3Hashother=null;
//        byte[] m = Hex.decode(strM1024);
        byte[] bytes1=null;
...
//            sm3.update(bytes, 0, bytes.length);
        ...
        System.out.println("运算结束:"+(System.currentTimeMillis()-l));
