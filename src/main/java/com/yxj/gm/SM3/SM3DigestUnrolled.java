...
/**
 * SM3 with the compression-function 64-round loop unrolled 2x.
 * Public API identical to {@link SM3Digest}.
 */
public class SM3DigestUnrolled {
    ...
    private static void CF(int[] V, byte[] padded, int offset, int[] out, int[] W, int[] W1) {
        ...
        // 2x unrolled remaining 48 rounds
