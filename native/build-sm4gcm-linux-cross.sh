#!/bin/bash
# Cross-compile sm4gcm for Linux architectures without a native runner.
# Usage: ./build-sm4gcm-linux-cross.sh <arch> <cross-prefix>
# Example: ./build-sm4gcm-linux-cross.sh aarch64 aarch64-linux-gnu
...
OUT="$OUT_DIR/libsm4gcm.so"

# PCLMUL only on x86_64; cross targets use scalar fallback.
EXTRA_FLAGS=""
